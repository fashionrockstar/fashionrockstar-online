...
Project pages use the existing clean UI sans-serif family, compact headings, left-aligned role information, the year on the right, and more space between media. The owner approved these project interiors. Following review, Work's full-width covers and supplied proportions were restored from commit 61eb86e. Work no longer loads project-layout.css. All ten project links, their ordering, galleries and the Micaela looping video remain intact.

The owner subsequently approved centered Work titles in Inter Medium: white uppercase lettering, balanced wrapping at approximately 32 characters per line, 24–48px desktop sizing and 18–24px mobile sizing, with a soft localized dark backdrop. The captions fade in over 180ms on desktop hover or keyboard focus and remain visible on touch and phone screens. Reduced motion removes the fade; overlays cannot intercept clicks. These title-only rules live in work-titles.css, loaded only by Work. Cover geometry, the Selected Work heading, title wording, videos and approved project interiors remain unchanged. Source checks pass; a fresh automated visual check is unavailable because the browser connection cannot start.
